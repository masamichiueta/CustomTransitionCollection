...
class InteractiveTransitionAnimator: UIPercentDrivenInteractiveTransition, UIViewControllerAnimatedTransitioning, UIViewControllerInteractiveTransitioning {
    
    var presenting: Bool = true
    var interactive: Bool = false
    
    var enterPanGestureRecognizer: UIScreenEdgePanGestureRecognizer!
    var sourceViewController: UIViewController! {
        didSet {
            enterPanGestureRecognizer = UIScreenEdgePanGestureRecognizer()
            enterPanGestureRecognizer.addTarget(self, action: "handleOnStagePan:")
            enterPanGestureRecognizer.edges = UIRectEdge.Left
